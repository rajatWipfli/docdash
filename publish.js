...
exports.publish = function (taffyData, opts, tutorials) {
    ...
    function generateTutorial(title, tutorial, filename) {
        var tutorialData = {
            ...
            breadcrumbs: generatebreadCrumbs(tutorial, title)
        };
...
function generatebreadCrumbs(docData, title) {
    let html = '<ul class="breadcrumb">';
    html += '<li class="breadcrumb-item">' + linkto('Home') + '</li>';
    if (docData.parent && docData.parent.name) {
        html += '<li class="breadcrumb-item">' + linktoTutorial(docData.parent.longName, docData.parent.name) + '</li>';
    }
